...
saveas(gcf, 'nombre_del_archivo.svg')  % Guarda la figura actual como una imagen PNG
print(gcf, 'nombre_del_archivo1.svg', '-dsvg')  % Otra forma de guardar la figura actual
...
ylabel('Posicion Angular [grados]','FontWeight','bold','FontSize',10,'Color',[0 0 0], 'Rotation', 90); 
xlabel('Tiempo [ms]','FontWeight','bold','FontSize',10,'Color',[0 0 0]);
hold on;
grid on;
% Guardar la figura como SVG
%print('PosicionesServoIzquierdo','-dsvg');
...
grid on;
% Guardar la figura como SVG
%print('PosicionesServoDerecho','-dsvg');

axes(handles.axes_velocidades_servo_izq); % Selecciona el axes a trabajar
cla;
axis([0 5 0 5]); % ejes por defecto de la grafica
title('Velocidades Servo Izquierdo')
ylabel('Velocidad Angular [grados/seg]','FontWeight','bold','FontSize',10,'Color',[0 0 0], 'Rotation', 90); 
xlabel('Tiempo [ms]','FontWeight','bold','FontSize',10,'Color',[0 0 0]); 
hold on;
grid on;
% Guardar la figura como SVG
%print('VelocidadesServoIzquierdo','-dsvg');
...
grid on;
% Guardar la figura como SVG
%print('VelocidadesServoDerecho','-dsvg');
...
ylabel('Posicion eje Y [mm]','FontWeight','bold','FontSize',12,'Color',[0 0 0], 'Rotation', 90);
xlabel('Posicion eje X [mm]','FontWeight','bold','FontSize',12,'Color',[0 0 0]); 
hold on;
grid on;
% Guardar la figura como SVG
%print('Trayectoria_mecanismo','-dsvg');
...
if filename == 0 % Pregunta si NO se ha seleccionado un archivo y se ha cerrado el cuadro de dialogo
    ...
    scatter(vector_tiempo_angulos_izq,vector_angulos_izq_GR,'.','MarkerEdgeColor',[0 0.6 0]);               % Grafica los datos con el carga exitosa de color verde
        % Guardar gráficos
    %print(handles.axes_posiciones_servo_der, 'PosicionesServoDerecho.svg','-dsvg');
    %print(handles.axes_velocidades_servo_izq, 'VelocidadesServoIzquierdo.svg','-dsvg');
    %print(handles.axes_velocidades_servo_der, 'VelocidadesServoDerecho.svg','-dsvg');
    %print(handles.axes_trayectoria, 'TrayectoriaMecanismo.svg','-dsvg');
...
fig = ancestor(handles.axes_posiciones_servo_der, 'figure');
print(fig, 'grafiesta.svg','-dsvg');
...
print(fig, 'grafic.svg','-dsvg');
    ...
    brazoy=[By Cy1 Cy2 Dy ];
    plot(brazox,brazoy,'Color','blue','Linewidth',2)
    saveas(gcf, 'mi_figura_estadistica.svg', 'svg');
    %FIN DE LA GRAFICCION DE LA CINEMATICA
...
%print('mi_figura_estadistica', '-dsvg'); % Opción con print
